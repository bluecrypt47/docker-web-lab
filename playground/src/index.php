...
<header id="header">
  <div class="container">
    ...
    <form id="searchForm" method="get">
        <input type="hidden" name="p" value="ketquatimkiem" >
        ...
        <div class="row">
          <div class="leftbar_content">
            <h2>Tin mới cập nhật</h2>
              <?php
                switch ($p) {
                    case "chitiettin": include "chitiettin.php"; break;
                    case "tintrongloai": include "tintrongloai.php"; break;
                    case "kietquatimkiem": include "ketquatimkiem.php"; break;
                    default: include $p;
                }
              ?>
          </div>
