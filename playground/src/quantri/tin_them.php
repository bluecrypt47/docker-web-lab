...
if(isset($_POST['TieuDe'])) {
    ...
    $qt->Tin_Them($TieuDe, $TieuDe_KD, $TomTat, $Ngay, $AnHien, $TinNoiBat, $urlHinh, $NoiDung, $idTL, $idLT);
            ...
            <div class="body">
                <form id="form_validation" method="POST">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="TieuDe" required minlength="10" maxlength="100">
                            <label class="form-label">Tiêu đề</label>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" class="form-control" name="TieuDe_KhongDau">
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea name="TomTat" cols="30" rows="5" class="form-control no-resize"></textarea>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-6">
                            <div class="form-group form-float">
                                <input type="radio" name="AnHien" id="AnHien_0" value="0" checked>
                                <label for="AnHien_0">Hiện</label>
                                <input type="radio" name="AnHien" id="AnHien_1" value="1">
                                <label for="AnHien_1">Ẩn</label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-3 col-xs-6">
                            <div class="form-group form-float">
                                <input type="radio" name="TinNoiBat" id="TinNoiBat_0" value="0">
                                <label for="TinNoiBat_0">Tin thường</label>
                                <input type="radio" name="TinNoiBat" id="TinNoiBat_1" value="1" checked>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="datepicker" name="Ngay">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <textarea name="NoiDung" cols="30" rows="10" class="form-control" required></textarea>
                        </div>
                    </div>
